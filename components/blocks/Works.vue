<script setup>
const { data: spheres, pending } = useFetch('https://api.free-eco.ru/api/v1/works/spheres');
...
<template>
  <div class="container-xl d-flex justify-content-center rounded shadow-lg my-20"
     id="bg">
