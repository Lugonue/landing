<script setup>
const { data: spheres, pending, error } = await useQuery(`works/spheres`);
...
<template>
  <div class="container-xl d-flex justify-content-center rounded shadow-lg my-20 mb-20" id="works" v-if="!error">
