...
<template>
  <div class="container-xl d-flex justify-content-center border rounded"
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-sm-12  d-flex flex-column ">
                          <div class="rounded p-4 bg-white shadow-sm mb-3">
                            ...
                            <i class="fa-duotone fa-audio-description"></i>
                          </div>
                          <div class="rounded p-4 bg-white shadow-sm mb-3">
...
<style scoped>
#bg {
  background: linear-gradient(45deg, rgb(239, 201, 239) 10%, rgb(245,248,250) 50%);
}
