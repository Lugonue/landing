...
const landingMenu = [
  {
    id: 1,
    title: 'О cервисе',
    link: 'https://free-eco.ru#about',
    target: ''
  },
  {
    id: 2,
    title: 'Как это работает',
    link: 'https://free-eco.ru#how_work',
    target: ''
  },
  {
    id: 4,
    title: 'Контакты',
    link: 'https://free-eco.ru#contacts',
    target: ''
  },
]
            ...
            <nav
              ...
              <div class="menu-item" v-for="item in landingMenu" :key="item.id">
                ...
                <a class="menu-link nav-link py-3 px-4 px-md-1 px-lg-1 px-xl-2 px-xxl-4 fw-bolder fs-md-6" data-kt-scroll-toggle="true"
                  data-kt-drawer-dismiss="true" :href="(item.link)" target="_blank">{{ item.title }}</a>
                <!--end::Menu link-->
              </div>
            </nav>
            <!--end::Menu-->
